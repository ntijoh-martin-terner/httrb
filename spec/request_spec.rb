...
describe 'request' do # rubocop:disable Metrics/BlockLength
  describe 'get-index.request' do
    before do
      @request = Httrb::Request.new(File.read('./spec/example_requests/get-index.request.txt').gsub("\n", "\r\n"))
    end
  ...
  describe 'get-examples.request' do
    before do
      @request = Httrb::Request.new(File.read('./spec/example_requests/get-examples.request.txt').gsub("\n", "\r\n"))
    end
  ...
  describe 'get-fruits-with-filter.request' do
    before do
      @request = Httrb::Request.new(File.read('./spec/example_requests/get-fruits-with-filter.request.txt').gsub("\n", "\r\n"))
    end
  ...
  describe 'post-login.request' do
    before do
      @request = Httrb::Request.new(File.read('./spec/example_requests/post-login.request.txt').gsub("\n", "\r\n"))
    end
